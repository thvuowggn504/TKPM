...
<body>
  <header>
    ...
    <nav>
      ...
      <a href="lg&rgt.html" id="login-btn"><button><span>Login</span></button></a>
    ...
    <div class="container">
      <div class="content">
        ...
        <p>
          ...
          a
          seamless, secure, and convenient online shopping experience,<br> making it easier than ever to find everything
          you
          need.
        </p>
        <div class="action">
